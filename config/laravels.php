...
return [
    ...
    'server'                   => env('LARAVELS_SERVER', 'help.ouyang.wiki'),
    ...
    'websocket'                => [
        'enable' => true,
        'listen_port'=>'9501',
        'handler' => App\WebSocketService\WebSocketService::class,
    ],
    'sockets'                  => [],
    'processes'                => [
        //[
   ...
   /* 'swoole_tables'            => [
        ...
        'ws_users'          =>[
            ...
            'column' => [// Table的列定义$roomid,$fd,$name,$email,$avatar
                ...
                ['name' => 'roomid', 'type' => \Swoole\Table::TYPE_STRING, 'size' => 8],
                ['name' => 'fd', 'type' =>  \Swoole\Table::TYPE_INT, 'size' => 8],
                ['name' => 'name', 'type' => \Swoole\Table::TYPE_STRING, 'size' => 100],
                ['name' => 'email', 'type' => \Swoole\Table::TYPE_STRING, 'size' => 100],
                ['name' => 'avatar', 'type' => \Swoole\Table::TYPE_STRING, 'size' => 100],
        ...
        'ws_rooms'=>[
            'size'   => 102400,//Table的最大行数
            'column' => [// Table的列定义$roomid,$fd,$name,$email,$avatar
                ['name' => 'users', 'type' => \Swoole\Table::TYPE_STRING, 'size' => 1024],
            ]
        ],
        'ws_roomUsers'=>[
            'size'   => 102400,//Table的最大行数
            'column' => [// Table的列定义$roomid,$fd,$name,$email,$avatar
                ['name' => 'infos', 'type' => \Swoole\Table::TYPE_STRING, 'size' => 1024],
                ['id'=>'user_id','type'=>\Swoole\Table::TYPE_INT,'size'=>8],
            ]
        ],
    ],*/
    'register_providers'       => [],
